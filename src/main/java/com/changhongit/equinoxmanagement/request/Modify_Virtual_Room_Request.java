...
@XStreamAlias("Modify_Virtual_Room_Request")
public class Modify_Virtual_Room_Request extends BaseRequest {

	@ApiModelProperty(required = true)
	@XStreamAlias("VirtualRoom")
	private VirtualRoom virtualRoom;

	public Modify_Virtual_Room_Request(int requestId, VirtualRoom virtualRoom) {
	...
	public Class[] getTypes() {
		return new Class[] { Modify_Virtual_Room_Request.class, VirtualRoom.class, Attendee.class, ReservedPorts.class,
